    ...
    <footer id="about" className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            <h3 className="font-serif text-xl mb-4">Tabletop Purse Pal</h3>
            <p className="text-sm opacity-70 leading-relaxed">
              Elegant, foldable purse holders designed to keep your handbag safe, clean, and always within reach.
            </p>
          </div>
          <div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10 text-center text-xs opacity-50">
          © {new Date().getFullYear()} Tabletop Purse Pal. All rights reserved.
        </div>
      </div>
    </footer>
  );
